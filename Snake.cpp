...
//UTFT myGLCD6(ITDB32S,38,39,40,41);
...
Snake::Snake(NESController *controller, Adafruit_WS2801 *strip):Game(controller, strip){
	segments = NULL;
	moveDirection = XDOWN;
	score = 0;
	highScore=0;
...
void Snake::setGameOver(){
	...
	for (int thisNote = 0; thisNote < 6; thisNote++) {
     ...
     int pauseBetweenNotes = noteDuration6 * 0.70;
